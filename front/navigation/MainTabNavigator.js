  ...
  return (
    ...
    >
      ...
      <MainTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => <Ionicons name="chatbubble-ellipses-outline" color={color} size={24} />,
          tabBarLabel: "chat",
        }}
      />
      <MainTab.Screen name="Status" component={TabTwoNavigator} />
      <MainTab.Screen name="Calls" component={LoginScreen} />
    </MainTab.Navigator>
  );
}
...
function TabOneNavigator() {
  return (
    <TabOneStack.Navigator>
      <TabOneStack.Screen name="TabOneScreen" component={Map} options={{ headerTitle: "Tab One Title" }} />
    </TabOneStack.Navigator>
  );
}
